...
router.post("/sendss", (req, res) => {
    ...
    User.findOne({
        ...
        if (
            ...
            res.json("your question or answer is wrong");
        }
    });
});
...
router.route("/rating").post((req, res) => {
    ...
    Venues.findOne({ name: req.body.name }).then((user) => {
        console.log(req.body.Rating);
...
router.route("/postemail").post((req, res) => {
    User.findOne({ email: req.body.firstperson }).then((user) => {
        console.log(req.body.activityname);
...
router.route("/getintowaitlist").post((req, res) => {
    console.log(req.body.activityname);
    Wait.findOne({ activityname: req.body.activityname }).then((user) => {
        if (user) {
            console.log(req.body.email);
...
router.route("/capacity").post((req, res) => {
    ...
    Events.findOne({ name: req.body.name }).then((user) => {
        console.log(req.body.capacity);
