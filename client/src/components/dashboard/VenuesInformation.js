...
export default class VenuesInformation extends Component {
    ...
    changeRating(newRating, name) {
        ...
        if (!(this.state.UsersWhoRated.indexOf(UserID) >= 0)) {
            ...
            axios
                .post("http://localhost:5000/api/auth/rating", {
                    Rating: newRatingRound,
                    name: this.state.name,
                    NewRater: UserID,
                    TotalRating: newRatingRaw,
                })
                .then((response) => {
    ...
    componentDidMount() {
        ...
        axios
            .get("http://localhost:5000/api/auth/venues/" + this.props.match.params.id)
            .then((response) => {
                this.setState({
    ...
    onSubmit(e) {
        e.preventDefault();
        axios.put("http://localhost:5000/api/auth/removetimeslot", {
            name: this.state.name,
                    ...
                    <div class="event-page-header">
                            ...
                            <div class="event-poster-image-overlay overlay-gradient-frombottom">
                                <div class="event-poster-infobar">
                                    <ul class="event-wherewhen">
                                        ...
                                        <li>
                                            <p class="countdown-number" style={{ color: "white" }}>
                        ...
                        <div class="event-page-header__context">
                            <div class="event-page-title">
                                <Link class="event-category-tag" to={"/SearchVenue/"}>
                                    See Other Venues
                                </Link>
                                <div className="row">
                            ...
                            <center>
                                <div class="event-page-cta">
                                    ...
                                    <p style={{ textAlign: "center", padding: "20px" }}>
                                        Local Address: {this.state.address}
                                    </p>
                                    ...
                                    <div class="event-page-cta__action-bar">
                                        <form style={{ fontSize: "2rem", color: "white" }} onSubmit={this.onSubmit}>
                                            ...
                                            >
                                                ...
                                                <option value={this.state.TimeslotThree}>
                                                    {this.state.TimeslotThree}
                                                </option>
                                            </select>
                                            <input
                                                class="btn btn-cta"
