...
const Dashboard = ({ getCurrentProfile, deleteAccount, auth: { user }, profile: { profile, loading }, showevent }) => {
    useEffect(() => {
        getCurrentProfile();
    }, [getCurrentProfile]);
                ...
                <div class="">
                            ...
                            <div class="card">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        {" "}
                                        <Link to={"/registerevent/" + user._id}>
                                            {" "}
                                            <p style={{ color: "black" }}>
                                                {" "}
                                                <i class="fas fa-tasks fa"></i> Registered And Completed
                                            </p>
                                        </Link>
                                    </li>
                                    <li class="list-group-item">
                                        {" "}
                                        <Link to={"/waitinglistevent/" + user._id}>
                                            {" "}
                                            <p style={{ color: "black" }}>
                                                {" "}
                                                <i class="fas fa-plus-square fa"></i> Waitlisted Events
                                            </p>
                                        </Link>
                                    </li>
                                    <li class="list-group-item">
                                        ...
                                        <Link to="/edit-profile">
                                            <p style={{ color: "black" }}>
                                                {" "}
                                                <i className="far fa-id-badge" style={{ color: "black" }}></i> Your
                                                Profile
                                            </p>
                                        </Link>
                                    </li>
                    ...
                    <div class="grid">
                        <div class="column lg12">
                            <h2 class="section__title" style={{ textAlign: "center" }}>
                                Events You Love{" "}
                                <i
                                    class="fas fa-heart fa-lg"
                                    style={{ color: "#FF1493", width: "25px", height: "25px" }}
                                ></i>
                            </h2>
                        </div>
