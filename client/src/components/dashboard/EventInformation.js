...
export default class EventInformation extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .get("http://localhost:5000/api/auth/show/" + this.props.match.params.id)
            .then((response) => {
                this.setState({
    ...
    onsubmit(e) {
        ...
        axios
            .post("http://localhost:5000/api/auth/capacity", {
    ...
    reg() {
        if (this.state.pay == "paid")
            return (
                ...
                >
                    <Link to={"/paymentq"}>Register</Link>
                </button>
            );
        else
            return (
                <button class="btn btn-cta" href="#" onClick={this.onsubmit} disabled={this.state.disabled1}>
                    <Link to={"/payment/" + this.props.match.params.id}>Register</Link>
                </button>
            );
    }
    render() {
            ...
            <div>
                    ...
                    <div class="event-page-header">
                        ...
                        <div class="event-page-header__context">
                            <div class="event-page-title">
                                <Link class="event-category-tag" to={"/SearchEvents/"}>
                                    See Other Events
                                </Link>
                            ...
                            <div class="event-page-cta">
                                ...
                                <center>
                                    ...
                                    <p>
                                        <i style={{ color: "white" }} class="fas fa-chair"></i>Event Capacity{" "}
                                        {this.state.capacity}
                                    </p>

                                    <div class="event-page-cta__action-bar">
                                        <p hidden={this.state.showmessage}>
                                            this event is full, you will be put in waitlist if you still want Register
                                            for this event{" "}
                                        </p>
                                        {this.reg()}
                                        <span class="data-tag data-tag-white">{this.state.pay} </span>
                                        <p class="btn2" style={{ fontSize: "3rem", color: "white" }}>
                    ...
                    <div class="event-page-content">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h3 class="card-title">
                                                    About the Host{" "}
                                                    <i style={{ color: "skyBlue" }} class="fas fa-check-square"></i>
                                                </h3>
                                                <p class="card-text" style={{ padding: "2px" }}>
                                                    Hey everyone, Prashant here. From here on out I will be your main
                                                    point of contact for your adventure! We like to offer
                                                    outside-the-box travel experiences, not stuffy off-the-shelf tours.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="event-page-content__hype">
                            ...
                            <h4 style={{ textAlign: "center", padding: "20px" }}>
                                <i style={{ color: "skyBlue" }} class="fas fa-map-marker-alt"></i> {this.state.address}
                            </h4>

                            <div class="event-recommendations"></div>
                        </div>
                    </div>
                    <hr></hr>
                ...
                <div class="event-page-events-recommended">
                    ...
                    <p style={{ textAlign: "center" }}>
                        Whether you're a foodie or a hiker, an animal lover or an archaeology buff, there’s an adventure
                        ...
                        <div class="events-list__card-wrap">
                            <div class="event-card">
                                <div class="event-card__poster1">
                                    <div class="event-card-poster-overlay overlay-gradient-frombottom"></div>
                                </div>
