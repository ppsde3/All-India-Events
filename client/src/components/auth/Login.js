...
const Login = ({ login, isAuthenticated }) => {
    ...
    const responseGoogle = (res) => {
        login(window.localStorage.getItem("emailID"), "ppsde3@gmail.com");
    };

    const responseFacebook = (response) => {
        console.log(response);
        if (response) login(window.localStorage.getItem("emailID"), "ppsde3@gmail.com");
    };
            ...
            <section className="formslayout2">
                ...
                <div className="formslayout2-inner">
                    <div class="page">
                        <div class="login">
                            <div class="">
                                <h1 class="text-center" style={{ marginTop: "20px", marginLeft: "80px" }}>
                                    Login
                                </h1>
